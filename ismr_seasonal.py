...
if __name__ == "__main__":
    ...
    file_path1 = raw_input("Path to output forcing.diag.nc containing one year of 5-day averages (December will be used): ")
    file_path2 = raw_input("Path to the following forcing.diag.nc containing 5-day averages for the next year (January through November will be used): ")
