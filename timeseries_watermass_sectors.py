...
def timeseries_watermass_sectors (mesh_path, output_path, start_year, end_year, log_file, fig_dir=''):
    ...
    # Colours for plotting each water mass
    ...
    # Set up array of percent water mass in each sector
    ...
    for year in range(start_year, end_year+1):
        ...
        for wm_key in range(num_watermasses):
            for sector in range(num_sectors):
                percent_watermass[wm_key, sector, year-start_year] = vol_watermass[wm_key, sector]/vol_sectors[sector]*100
