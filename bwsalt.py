...
# Make a circumpolar plot of bottom water salinity annually averaged over
...
if __name__ == "__main__":
    ...
    file_path = input("Path to FESOM oce.mean.nc containing one year of output: ")
    ...
    if action == 's':
        ...
        save = False
        fig_name = None
    bwsalt(mesh_path, file_path, save, fig_name)
